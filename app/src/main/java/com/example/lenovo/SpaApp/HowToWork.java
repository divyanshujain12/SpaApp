...
public class HowToWork extends AppCompatActivity{
    ...
    private void InitViews() {
        ...
        pagerIndicator.startAnimation(AnimationUtils.loadAnimation(HowToWork.this, R.anim.fade_in_animation));
      ...
      /*  splashLogoAnimation = AnimationUtils.loadAnimation(this, R.anim.splash_logo_animation);
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                if (MySharedPereference.getInstance().getBoolean(HowToWork.this, Constants.LOGGED_IN)) {
                    Intent i = new Intent(HowToWork.this, HomeActivity.class);
                    startActivity(i);
                    finish();
                } else
