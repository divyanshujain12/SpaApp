 ...
 */
public class InProgressAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener, CallBackInterface {
    ...
    public InProgressAdapter(Context context, ArrayList<AppointmentsModel> appointmentsModels) {
    ...
    public void onClick(View v) {
        ...
        AlertMessage.showAlertDialogWithCallBack(context, context.getString(R.string.alert), context.getString(R.string.are_you_sure_cancel), new SnackBarCallback() {
            ...
            public void doAction() {
                ...
                CallWebService.getInstance(context, true).hitWithJSONObjectVolleyWebService(CallWebService.POST, Constants.WebServices.CANCEL_ORDER, CreateCommonJSON.getInstance().createJsonObjectForCancelOrder(context, appointmentsModels.get(id).getOrder_id()), InProgressAdapter.this);
            }
        });
    }
